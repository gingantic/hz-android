...
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeInit(
...
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeLoadHeader(
        JNIEnv *env, jobject thiz,
...
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeAddFont(
        JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeReloadFonts(
        JNIEnv *env, jobject thiz, jlong handle) {
    (void)env; (void)thiz;
    AssDirectContext *ctx = (AssDirectContext *)(intptr_t)handle;
    if (ctx) {
        ass_direct_reload_fonts(ctx);
    }
}

JNIEXPORT void JNICALL
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeSetFrameSize(
        JNIEnv *env, jobject thiz, jlong handle, jint width, jint height) {
    (void)env; (void)thiz;
    AssDirectContext *ctx = (AssDirectContext *)(intptr_t)handle;
    if (ctx) {
        ass_direct_set_frame_size(ctx, width, height);
    }
}

JNIEXPORT void JNICALL
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeProcessChunk(
        JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeFlush(
        JNIEnv *env, jobject thiz, jlong handle) {
    (void)env; (void)thiz;
    AssDirectContext *ctx = (AssDirectContext *)(intptr_t)handle;
...
JNIEXPORT void JNICALL
Java_com_rhnxdev_hzplayer_data_datasource_subtitle_assrender_AssDirectBridge_nativeDestroy(
        JNIEnv *env, jobject thiz, jlong handle) {
    (void)env; (void)thiz;
    AssDirectContext *ctx = (AssDirectContext *)(intptr_t)handle;
