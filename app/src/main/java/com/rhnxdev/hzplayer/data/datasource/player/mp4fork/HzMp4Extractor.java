...
import static com.rhnxdev.hzplayer.data.datasource.player.mp4fork.BoxParser.parseTraks;
import static com.rhnxdev.hzplayer.data.datasource.player.mp4fork.MimeTypeResolver.getContainerMimeType;
...
@UnstableApi
public final class HzMp4Extractor implements Extractor {

  /**
   * Creates a factory for {@link HzMp4Extractor} instances with the provided {@link
   * SubtitleParser.Factory}.
   */
  public static ExtractorsFactory newFactory(SubtitleParser.Factory subtitleParserFactory) {
    return () -> new Extractor[] {new HzMp4Extractor(subtitleParserFactory)};
  }
  ...
  public static final ExtractorsFactory FACTORY =
      () ->
          new Extractor[] {
            new HzMp4Extractor(SubtitleParser.Factory.UNSUPPORTED, FLAG_EMIT_RAW_SUBTITLE_DATA)
          };
  ...
  /**
   * @deprecated Use {@link #HzMp4Extractor(SubtitleParser.Factory)} instead
   */
  @Deprecated
  public HzMp4Extractor() {
   ...
   *     extraction.
   */
  public HzMp4Extractor(SubtitleParser.Factory subtitleParserFactory) {
    this(subtitleParserFactory, /* flags= */ 0);
  }

  /**
   * @deprecated Use {@link #HzMp4Extractor(SubtitleParser.Factory, int)} instead
   */
  @Deprecated
  public HzMp4Extractor(@Flags int flags) {
   ...
   */
  public HzMp4Extractor(SubtitleParser.Factory subtitleParserFactory, @Flags int flags) {
