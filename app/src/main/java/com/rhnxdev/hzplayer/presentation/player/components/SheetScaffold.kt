 ...
 *
 * Fully unified to a premium, dark glass-like void design with custom drag handles,
 * consistent close action layout, and slots for contextual actions/navigation.
 */
...
fun SheetScaffold(
    ...
    ModalBottomSheet(
        ...
        BoxWithConstraints {
            // Cap the sheet below the status bar so a fully-expanded sheet
            // (e.g. a long queue) never slides under the notification bar.
            // Resolves to 0 while the system bars are hidden (video player).
